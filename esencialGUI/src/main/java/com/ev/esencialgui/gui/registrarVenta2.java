 ...
 */
public class registrarVenta2 extends javax.swing.JFrame {
   ...
   int loteId;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registrarVenta2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registrarVenta2().setVisible(true);
            }
        });
    }
